...
public class LineNode {
	...
	// return if line intersect with LineNode in the middle of the segment
...
//		if(line.pt2.isEquals(pt1) || line.pt2.isEquals(pt2) || line.pt1.isEquals(pt1) || line.pt1.isEquals(pt2))
//			return false;		
		return false;		// neu co sua thi day la true
	}
